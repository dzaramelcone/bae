...
class SourceRoom:
    ...
    def _write_subresource(self, name: str, description: str = "") -> str:
        ...
        module_path = f"bae.repl.rooms.source.{name}.view"
