...
<task type="auto">
  ...
  <action>
    ...
    4. **bae/repl/ai.py:38** — Update `from bae.repl.spaces.home.service import (...)` → `from bae.repl.spaces.home import (...)` (use package re-export now that home/__init__.py exports these names). This import references service.py directly and must be updated here (not earlier) because home/__init__.py only gains these exports in step 3 above.
  </action>
