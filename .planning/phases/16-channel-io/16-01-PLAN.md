...
<!-- TDD plan: executor reads <feature> block, not <task> elements.
     RED phase uses <behavior>, GREEN phase uses <implementation>. -->
...
- toggle_channels() async function created and unit tested; keybinding wiring deferred to Plan 02
